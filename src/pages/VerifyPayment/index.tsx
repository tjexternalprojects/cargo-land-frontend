    ...
    return (<>
        ...
        <div className=" min-h-screen flex items-center justify-center">
            <div className="bg-white rounded-md  p-8 max-w-md w-full flex flex-col items-center justify-center animate__animated animate__bounceIn ">
                ...
                {loading ? <RingLoader size={300} textColor="text-blue-900" /> :
                    <>
                        <div className="flex items-center justify-center mb-8">
                            <BsCheckLg className='text-green-700 text-7xl' />
                        </div>
                        <h1 className="text-3xl font-bold text-gray-800 text-center mb-6">Payment Successful</h1>
                        <p className="text-lg text-gray-700 text-center mb-8">
                            Thank you for your payment! Your transaction has been processed successfully. <hr /><br /><span className='font-bold text-red-500 uppercase'>{paymentStatus}</span>
                        </p>
