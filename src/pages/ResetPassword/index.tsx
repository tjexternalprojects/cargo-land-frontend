...
const Login = () => {
const {handleRestPassword, setResetPassword, resetPassword} = useResetPassword()
	return (
		<>
			<Header />
				...
				<div className=" bg-gradient-to-b  from-white via-white/40 to-white  w-full">
					<div className='relative'>
						<div className='flex items-center justify-center  h-screen '>
                            ...
                            <form className=" text-gray-500 flex flex-col space-y-4" onSubmit={handleRestPassword}>
