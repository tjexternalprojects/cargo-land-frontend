...
const index = () => {
	const { closeForgotPassword, handleForgotPassword, setEmail, showLoading, email } =
		useForgotPassword();
	return (
		<form className=" space-y-3 w-full " onSubmit={handleForgotPassword}>
			<div className="bg-white h-11 px-3 border-b border-blue-800 w-full  flex items-center shadow-md animate__animated animate__fadeInUp animate__faster ">
				<input
					type="email"
					value={email}
			...
			<div className="animate__animated animate__fadeInUp animate__faster ">
				...
				<div
					className="p-4 w-full flex items-center text-blue-800 space-x-3 cursor-pointer"
