		...
		<div className="mt-10 space-y-10   w-full">
			...
			<div className=" flex  gap-16  justify-between  flex-wrap md:flex-nowrap">
				<div className=" flex-grow">
					...
					<hr />
					{transaction_history.length == 0 ? <> <div className=" space-y-3 mt-3">
								...
								<div className="flex flex-col w-full space-y-8">
									{state.allShipments.slice(0, 1).map((val: any, index: number) => (
										<div key={index}>
											...
											<MapDirection
												height="30vh"
												startLocation={{ lng: parseFloat(val.current_location.longitude), lat: parseFloat(val.current_location.latitude) }}
