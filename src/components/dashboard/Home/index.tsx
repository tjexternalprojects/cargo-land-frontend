...
const home = () => {
  const [shipment_loading] = useUAllShipment(
      ...
      <div className="gap-4 flex justify-between flex-wrap md:flex-nowrap  w-full">
        ...
        <div className=" inline-flex rounded-md px-6 py-2 min-w-min bg-green-50  flex-grow w-72 justify-between  shadow-md items-center">
          <div className="w-full relative">
            ...
            {gPackageLoader && <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center">
                        ...
                        .map((val: any, index: number) => (
                          <div key={index}>
                            ...
                            <MapDirection
                              ...
                              endLocation={{
                                lng: parseFloat(
                                  val.shipment_destination.longitude
                                ),
                                lat: parseFloat(
                                  val.shipment_destination.latitude
                                ),
                              }}
                            />
                          </div>
