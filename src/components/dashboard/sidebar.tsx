import { CiSettings, logo, RiPriceTag2Line, TbLayoutDashboard, TbLogout, TbTruckDelivery, userImg } from '../../assets';
    ...
    return (
        <div className=' bg-blue-900 fixed h-screen w-64  flex flex-col justify-between'>
                ...
                <ul className=' text-lg  font-bold'>
                    ...
                    <li>
                        <NavLink className='flex flex-col'
                            ...
                            <div className={`${dashboardMatch ? 'bg-white text-blue-900 rounded-l-3xl py-3' : 'text-white'} px-3 flex items-center space-x-3 `}>
                    ...
                    <li>
                        <NavLink className='flex flex-col'
                            ...
                            <div className={`${deliveryMatch ? 'bg-white text-blue-900 rounded-l-3xl py-3' : 'text-white'} px-3 flex items-center space-x-3 `}>
                    ...
                    <li>
                        <NavLink className='flex flex-col'
                            to="/price">
                            <div className={`${priceMatch ? 'bg-white' : 'bg-blue-900'}`}>
                                <div className='h-4 bg-blue-900 rounded-br-3xl'></div>
                            </div>
                            <div className={`${priceMatch ? 'bg-white text-blue-900 rounded-l-3xl py-3' : 'text-white'} px-3 flex items-center space-x-3 `}>
                                <RiPriceTag2Line /> <span>Price List</span>
                            </div>
            ...
            <div className='text-white flex flex-col items-center p-8'>
                ...
                <div className=' transition-all duration-75 ease-linear rounded-full p-2 shadow-md hover:shadow-red-200 border-blue-900 border hover:border-slate-50 cursor-pointer'><CiSettings/></div>
                <div className='transition-all duration-75 ease-linear rounded-full p-2 shadow-md hover:shadow-red-200 border-blue-900 border hover:border-slate-50 cursor-pointer'> <TbLogout /></div>
                </div>
            </div>
        </div>
    );
