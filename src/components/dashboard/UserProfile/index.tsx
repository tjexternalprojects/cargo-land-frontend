        ...
        <div className="space-y-10  w-full ">
            ...
            <div className=" flex gap-3 mb-32 mb:mb-0 w-full ">
                ...
                <div className="fixed mt-16 pb-3 md:pb-0 md:bg-transparent bg-gray-200 bottom-0 md:top-20 w-full md:w-auto ">
                    ...
                    <div className="mt-3 md:mt-10 border-l-2 space-y-2 ">
                        <div
                            ...
                            className={`${state.userCurrentTab == 'item1'
                        ...
                        <div>
                            <div
                                ...
                                className={`${state.userCurrentTab == 'item2'
                                        ? 'border-l-4 border-l-blue-900 pl-4 text-blue-900 font-bold'
                                        : 'text-gray-400 pl-5'
                                    } cursor-pointer`}
                            >
                ...
                <div className=" w-full md:pl-16 mb-36 md:mb-0  ">
                    <motion.div
                        className={`${state.userCurrentTab == 'item1' ? 'inline-flex' : 'hidden'
                            } w-full pt-10 `}
                    ...
                    <motion.div
                        className={`${state.userCurrentTab == 'item2' ? 'inline-flex' : 'hidden'
                            } w-full pt-10 `}
                        variants={fadeSlide(animationDirection.direction)}
