    ...
    >
      ...
      <div
        className={`p-4  rounded-sm space-y-4  ${
          !editInfo
            ? "bg-gray-200  transition-all duration-75 ease-in-out "
            : "bg-white shadow-sm"
        }`}
      >
        <div>
        ...
        <div>
          ...
          <div className=" border-b-2 flex px-2">
            <input
              ...
              onChange={(e)=>setUpdateUserDetails({...updateUserDetails, phoneNumber:e.target.value})}
              required
            />
            <div className="text-xl text-gray-500">
              <BsTelephoneForward />
        ...
        <div>
          ...
          <div className=" border-b-2 flex px-2 ">
            <textarea
              ...
              onChange={(e)=>setUpdateUserDetails({...updateUserDetails, address:e.target.value})}
              className="w-full outline-none"
            ></textarea>
            <div className="text-xl text-gray-500">
              <AiOutlineEdit />
      ...
      <button
        disabled={!editInfo}
        type="submit"
        className={`hover:shadow-md mt-8  shadow-gray-50 shadow-sm w-full p-2 rounded-sm ${
