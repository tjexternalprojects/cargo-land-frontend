      ...
      <div className=" flex gap-3 mb-32 mb:mb-0 w-full ">
          ...
          <div className="mt-3 md:mt-10 border-l-2 space-y-2 flex flex-col  ">
            ...
            <div>
              {state.form_level > 2 ? (
				...
				{state.editShipment && <div className=" flex md:flex-col  gap-2">
            <button className="flex  items-center bg-red-700 justify-between  space-x-3 text-white  hover:transition-all duration-150 ease-in-out hover:shadow-md hover:shadow-blue-100  shadow-md shadow-slate-300">
              <div className="md:p-2 p-1 text-sm">Cancel Edit</div>
              <div
                className="bg-red-900 md:p-2 p-1 rounded-l-full h-full w-10  flex items-center justify-center" >
                x
              </div>
            </button>
            ...
            <button className="flex  items-center bg-blue-700 justify-between  space-x-3 text-white  hover:transition-all duration-150 ease-in-out hover:shadow-md hover:shadow-blue-100  shadow-md shadow-slate-300">
              ...
              <div
                className="bg-blue-900 md:p-2 rounded-l-full h-full w-10  flex items-center justify-center" >
                +
              </div>
            </button>
			</div>}
        ...
        <div className=" w-full md:pl-16 mb-36 md:mb-0  ">
          <motion.div
            ...
            animate={
              state.shipmentCurrentTab == "item1" ? "animate" : "initial"
            }
          >
            <NewShipmentForm />
          </motion.div>
          ...
          <motion.div
            ...
            variants={fadeSlide(animationDirection.direction)}
            animate={
              state.shipmentCurrentTab == "item2" ? "animate" : "initial"
            }
          >
            <RecipientDetails />
          </motion.div>
          ...
          <motion.div
            ...
            variants={fadeSlide(animationDirection.direction)}
            animate={
              state.shipmentCurrentTab == "item3" ? "animate" : "initial"
            }
          >
            <ShipmentSummary />
          </motion.div>
          ...
          <motion.div
            ...
            variants={fadeSlide(animationDirection.direction)}
            animate={
              state.shipmentCurrentTab == "item4" ? "animate" : "initial"
            }
          >
            <Payment />
          </motion.div>
