		...
		<>
			<div className="inline-flex flex-col items-center w-full">
				...
				<form className=" w-9/12 mt-5">
					...
					<hr className='mt-5'/>
					<div className='mt-5'>
					<button type='submit' className='hover:shadow-xl hover:shadow-blue-100 shadow-md w-full p-2 rounded-md border border-slate-100 bg-slate-50 font-bold text-blue-900 text-md'>Next</button>
					</div>
				</form>
			</div>
		</>
