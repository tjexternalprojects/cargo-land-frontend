...
const sidebar = () => {
	...
	const { userInfo, state, navigationLinks, location, handleToggleSidebar } = useSidebar();
	return (
		<div
					...
					{navigationLinks.map((val, index)=>(
					 <li>
						<NavLink
							...
							className={`${
								location.pathname == val.route_to ? '  bg-blue-900/20 border-l-blue-900 ' : 'border-l-white bg-white'
